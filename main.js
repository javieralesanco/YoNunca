let yoNunca = ['Yo nunca lo he hecho sin haber querido',
    ...
    'Yo nunca he pensado que dos de las personas presentes podrian liarse',
    ...
    'Yo nunca he pensado que dos de las personas presentes hace buena pareja',
...
document.addEventListener('DOMContentLoaded', () => {
    ponerFrase();
    document.querySelector('main').addEventListener('click', ponerFrase);
});
const ponerFrase = () => {
    document.getElementById('pregunta').textContent = yoNunca[Math.floor(Math.random() * (yoNunca.length + 1))];
};
// let result = yoNunca.filter((item, index) => {
//     return yoNunca.indexOf(item) === index;
// })
// document.addEventListener('DOMContentLoaded', () => {
//     cosa();
// })
// const cosa = () => {
//     //p es un textarea con id try
//     document.getElementById('try').value = "[";
//     result.forEach(element => {
//         document.getElementById('try').value += `'${element}',
//         ^_^`;
//     });
//     document.getElementById('try').value += "];";
// };
